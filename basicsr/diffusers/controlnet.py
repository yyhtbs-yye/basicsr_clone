...
from basicsr.diffusers.utils.controlnet_utils import change_base_model
from .stable_diffusion import StableDiffusion

from basicsr.diffusers.archs.attention_injection import AttentionInjection
...
class ControlStableDiffusion(StableDiffusion):
    ...
    def __init__(self,
        ...
        self.controlnet = build_network(controlnet, MODELS)
