...
@SCHEDULER_REGISTRY.register() # type: ignore
class EditDDPMScheduler:
    ...
    def __init__(self,
                 ...
                 trained_betas: Optional[Union[np.array, list]] = None, # type: ignore
    ...
    def _get_variance(self, t, predicted_variance=None, variance_type=None):
        ...
        # for rl-diffusion_scheduler https://arxiv.org/abs/2205.09991
            ...
            frac = (predicted_variance + 1) / 2 # type: ignore
    ...
    def step(self,
        ...
        if model_output.shape[1] == sample.shape[
            ...
            model_output, predicted_variance = torch.split(
                model_output, sample.shape[1], dim=1) # type: ignore
        else:
        ...
        if t > 0:
            sigma = self._get_variance(
                t, predicted_variance=predicted_variance)**0.5  # type: ignore
